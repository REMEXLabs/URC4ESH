...
public class UrcResource implements RESTResource { // , SitemapSubscriptionCallback, BroadcasterListener<OutboundEvent>
    ...
    public Response getEnvironmentContexts){
        ...
        if ((EnvironmentContextDefinition environmentContextDefinition = contextManager.getUserContext(contextId)) == null) {
            return Response.noContent().build() ;
        }
        return Response.ok(environmentContextDefinition);
    }
