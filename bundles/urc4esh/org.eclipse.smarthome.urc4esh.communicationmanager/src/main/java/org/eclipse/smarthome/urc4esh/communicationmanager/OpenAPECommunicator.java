 ...
 * @author Lukas Smirek
 */
public class OpenAPECommunicator implements Communicator {
    private static Logger logger = LoggerFactory.getLogger(OpenAPECommunicator.class);
     ...
     */
    public OpenAPECommunicator(final String userName, final String password) throws MalformedURLException {
        this(userName, password, "http://openape.gpii.eu");
    }

    public OpenAPECommunicator(final String userName, final String password, final String uri)
    ...
    public URI createEnvironmentContext(final EnvironmentContext envrionmentContext) throws URISyntaxException {
        return this.createContext(ENVIRONMENT_CONTEXT_PATH, EnvironmentContext.class);
    }

    public URI createEquipmentContext(final EquipmentContext equipmentContext) throws URISyntaxException {
        return this.createContext(EQUIPMENT_CONTEXT_PATH, equipmentContext);
    }
    ...
    public URI createTaskContext(final TaskContext taskContext) throws URISyntaxException {
        return this.createContext(TASK_CONTEXT_PATH, taskContext);
    }

    public URI createUserContext(final UserContext userContext) throws URISyntaxException {

        return this.createContext(USER_CONTEXT_PATH, userContext);
    ...
    public UserContext getUserContext(final String userContextId) {
        final Invocation.Builder invocationBuilder = this.webResource.path(USER_CONTEXT_PATH + userContextId).request();
